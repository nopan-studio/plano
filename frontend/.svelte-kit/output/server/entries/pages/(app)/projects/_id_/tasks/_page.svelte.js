import { a as attr_class, g as attr_style, f as stringify, b as attr, e as escape_html, d as derived, c as ensure_array_like } from "../../../../../../chunks/index2.js";
...
function KanbanCard($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div${attr_class("k-card svelte-7v0i77", void 0, {
      "ai-active": task.is_ai_working,
      "dragging": isDragging,
      "projecting": isDragging && dropStatus !== null,
      "drop-target": isDropTarget,
      "last-drop-target": isLastDropTarget,
      "dropped": isDropped
    })} draggable="true" role="button" tabindex="0"${attr_style(`view-transition-name: task-card-${stringify(task.id)}`)}${attr("data-task-id", task.id)}${attr("data-status", task.status)}>`);
...
function KanbanColumn($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--]--> <button class="add-task-col-btn svelte-mykq0n"${attr("title", `Add task to ${stringify(col.label)}`)}>+</button></div></div> <div class="kanban-col-sub svelte-mykq0n">${escape_html(col.sub)}</div> <div${attr_class("kanban-col-body svelte-mykq0n", void 0, { "drag-over": dropStatus === col.id })}${attr("data-status", col.id)} role="region"${attr("aria-label", `Tasks column for ${stringify(col.label)}`)}>`);
    ...
    if (each_array.length !== 0) {
      ...
      $$renderer2.push("<!--[!-->");
      $$renderer2.push(`<div${attr_class("empty-col svelte-mykq0n", void 0, { "drop-target": dropStatus === col.id })}>No ${escape_html(col.id === "bugs" ? "bugs recorded" : "tasks")}</div>`);
    }
    $$renderer2.push(`<!--]--></div></div>`);
  });
}
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    function $$render_inner($$renderer3) {
      ...
      $$renderer3.push(`<!--]--> <div${attr_class("kanban svelte-5cz8yj", void 0, { "is-dragging": draggingTaskId !== null })} role="main"><!--[-->`);
