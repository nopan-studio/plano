...
import { i as setContext, j as getContext, d as derived, c as attr, a as attr_class, f as stringify, e as escape_html, b as ensure_array_like, g as attr_style, k as bind_props } from "../../../../../../chunks/index.js";
...
class EditorState {
  ...
  set selectedEdge($$value) {
    return this.#selectedEdge($$value);
  }
...
function Icon($$renderer, $$props) {
  ...
  $$renderer.push(`<svg xmlns="http://www.w3.org/2000/svg"${attr("width", size)}${attr("height", size)} viewBox="0 0 24 24" fill="none"${attr("stroke", color)}${attr("stroke-width", stroke)} stroke-linecap="round" stroke-linejoin="round"${attr_class(`icon icon-${stringify(name)}`, "svelte-1eqehiz")}>${html(icons[name] || icons.start)}</svg>`);
}
function Toolbar($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!----></div> <div class="bi-text svelte-1rxnufp"><span class="bn svelte-1rxnufp">${escape_html(S.diagram.name)}</span> <span class="bt svelte-1rxnufp">${escape_html(TYPE_LABELS[S.diagram.type] || S.diagram.type)}</span></div></div></div> <div class="tb-mid svelte-1rxnufp"><div class="tb-group svelte-1rxnufp"><button${attr_class(`btn-tb ${stringify(S.selMode ? "active" : "")}`, "svelte-1rxnufp")} title="Selection Mode (Shift+Drag)">`);
  ...
  $$renderer.component(($$renderer2) => {
    ...
    if (isText()) {
      ...
      if (isTab() && columns().length) {
        ...
        for (let i = 0, $$length = each_array_1.length; i < $$length; i++) {
          ...
          $$renderer2.push(`<div class="ncol svelte-1crz6v4"><div${attr_class(`port-row l ${stringify(S.isConnecting?.source_id === node.id ? "pinned" : "")}`)}></div> `);
          if (c.pk) {
            $$renderer2.push("<!--[0-->");
          ...
          $$renderer2.push(`<!--]--> <span class="col-n">${escape_html(c.name)}</span> <span class="col-t">${escape_html(c.type || "")}</span> <div${attr_class(`port-row r ${stringify(S.isConnecting?.source_id === node.id ? "pinned" : "")}`)}></div></div>`);
        }
        $$renderer2.push(`<!--]--></div>`);
      } else {
        $$renderer2.push("<!--[-1-->");
    ...
    if (!isNote()) {
      ...
      for (let $$index_2 = 0, $$length = each_array_2.length; $$index_2 < $$length; $$index_2++) {
        ...
        $$renderer2.push(`<div${attr_class(`port port-${stringify(side)} ${stringify(S.isConnecting?.source_id === node.id ? "pinned" : "")}`, "svelte-1crz6v4")}></div>`);
      }
      $$renderer2.push(`<!--]-->`);
    } else {
      $$renderer2.push("<!--[-1-->");
...
function Edge($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (edge.label) {
      $$renderer2.push("<!--[0-->");
      $$renderer2.push(`<text class="elabel svelte-1nb6nut"${attr("x", (sc().x + tc().x) / 2)}${attr("y", (sc().y + tc().y) / 2 - 7)} text-anchor="middle">${escape_html(edge.label)}</text>`);
    } else {
      $$renderer2.push("<!--[-1-->");
    }
    $$renderer2.push(`<!--]--></g>`);
...
function Canvas($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (S.isConnecting) {
      $$renderer2.push("<!--[0-->");
      $$renderer2.push(`<path class="epath" d="M 0 0" style="visibility: hidden"></path>`);
    } else {
      $$renderer2.push("<!--[-1-->");
    }
    $$renderer2.push(`<!--]--></svg> `);
      ...
      $$renderer2.select(
        ...
        ($$renderer3) => {
          $$renderer3.option({ value: "default" }, ($$renderer4) => {
            $$renderer4.push(`Default / Association`);
          });
          $$renderer3.option({ value: "one_to_many" }, ($$renderer4) => {
            $$renderer4.push(`One to Many`);
          });
          $$renderer3.option({ value: "one_to_one" }, ($$renderer4) => {
            $$renderer4.push(`One to One`);
          });
          $$renderer3.option({ value: "many_to_many" }, ($$renderer4) => {
            $$renderer4.push(`Many to Many`);
          });
        },
        "svelte-tj8zpd"
      );
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    function $$render_inner($$renderer3) {
      $$renderer3.push(`<div class="editor-container svelte-zvkqlj"><div class="canvas-wrap svelte-zvkqlj">`);
      Canvas($$renderer3, {
        get canvasWrap() {
          return canvasWrap;
        },
