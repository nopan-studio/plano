import { a as attr_class, b as attr, e as escape_html, c as ensure_array_like, d as derived, h as head } from "../../../chunks/index2.js";
...
function AIIndicator($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let activeTools = [];
    $$renderer2.push(`<div id="mcp-status-container" class="svelte-19iwk23"><!--[-->`);
    const each_array = ensure_array_like(activeTools);
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      let tool = each_array[$$index];
      $$renderer2.push(`<div${attr_class("flat-indicator svelte-19iwk23", void 0, {
        "is-active": tool.status === "active",
        "is-done": tool.status === "done"
      })}><div class="indicator-header svelte-19iwk23"><div${attr_class("status-badge svelte-19iwk23", void 0, { "success": tool.status === "done" })}><div class="status-dot svelte-19iwk23"></div> ${escape_html(tool.status === "done" ? "TASK COMPLETE" : "AI WORKING")}</div></div> <div class="indicator-main svelte-19iwk23"><div${attr_class("icon-box svelte-19iwk23", void 0, { "success": tool.status === "done" })}>`);
      if (tool.status === "done") {
        $$renderer2.push("<!--[0-->");
        Icon($$renderer2, { name: "check", size: 14, color: "var(--green)", stroke: 3 });
      } else {
        $$renderer2.push("<!--[-1-->");
        Icon($$renderer2, { name: "ai", size: 14, color: "var(--accent)", stroke: 2.5 });
      }
      $$renderer2.push(`<!--]--></div> <div class="details svelte-19iwk23"><div class="title-text svelte-19iwk23">AI ACTION</div> <div class="value-text svelte-19iwk23">${escape_html(tool.tool)}</div></div></div> `);
      if (tool.status === "active") {
        $$renderer2.push("<!--[0-->");
        $$renderer2.push(`<div class="flat-progress svelte-19iwk23"><div class="flat-bar svelte-19iwk23"></div></div>`);
      } else {
        $$renderer2.push("<!--[-1-->");
      }
      $$renderer2.push(`<!--]--></div>`);
