...
{:else}
  ...
  <div class="stat-row">
    ...
    <div class="stat">
      ...
      <div class="stat-v">{stats.tasks_by_status?.done || 0}</div>
    ...
    <div class="stat">
      ...
      <div class="stat-v">{stats.tasks_by_status?.in_progress || 0}</div>
    ...
    <div>
      ...
      <div class="form-card">
        <div class="dm-field-row">
          <div class="dm-field">
            ...
            <select bind:value={project.status} onchange={() => patchProject({status: project.status})} class="full">
          ...
          <div class="dm-field">
            ...
            <select bind:value={project.priority} onchange={() => patchProject({priority: project.priority})} class="full">
        ...
        <div class="dm-field-row" style="margin-top:16px">
          <div class="dm-field">
            ...
            <div style="display:flex;align-items:center;gap:12px">
              <input type="range" bind:value={project.progress_pct} min="0" max="100" style="flex:1;accent-color:var(--accent)" 
        ...
        <div class="dm-field-row" style="margin-top:16px">
          <div class="dm-field">
            ...
            <input type="date" bind:value={project.target_date} onchange={() => patchProject({target_date: project.target_date})} class="full">
          </div>
        </div>
      ...
      {#if milestones.length}
        {#each milestones.slice(0,5) as m}
          <div class="feed-item" style="cursor:pointer" onclick={() => location.href = `/projects/${pid}/milestones`}>
...
{#if showEditModal}
  <div class="detail-overlay" onclick={e => e.target === e.currentTarget && (showEditModal = false)}>
      ...
      <div class="dm-body">
        <div class="dm-field-row">
          ...
          <div class="dm-field">
            ...
            <input type="number" bind:value={editData.progress_pct} min="0" max="100" class="full">
          </div>
        </div>
        <div class="dm-section">
          <label class="dm-section-label">Description</label>
          <textarea bind:value={editData.description} style="min-height:120px"></textarea>
        </div>
      </div>
      <div class="dm-footer">
